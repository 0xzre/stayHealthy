...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="flex flex-row items-center flex-start w-[100vw] md:w-[30vw] h-[50vw] md:h-[15vw] rounded-[16px] p-6 bg-[#2DAE77] shadow-2xl">
        ...
        <div className="flex flex-col p-6">
          Food Intake
          {foodIntake.map(
            (food) => ( <div className="flex flex-row  justify-between"> <div> {food.FoodItem} </div> <div> {food.Cals_per100grams} </div> </div>)
          )}
